...
class MessageBoard(object):
    ...
    def draw(self):
        ...
        for line in self.text:
            ...
            if (
                    line_sf.get_width() + x_pos + self.padding > self.rect.right or line_sf.get_height() + y_pos + self.padding > self.rect.bottom):
...
class textEntry(object):
    ...
    def __init__(self, surface, pos=vec2d(0, 0), size=vec2d(200, 50), text="", textcolor=(0, 0, 0), padding=0,
                 bgcolor=(255, 255, 255)):
